...
class SkinCbpTranscription extends SkinTemplate {
	...
	var $skinname  		= 'cbptranscription';
	var $stylename 		= 'CbpTranscription';
...
<img src="<?php $this->text('stylepath'); ?>/CbpTranscription/logo.gif" alt="Transcribe Bentham: A Collaborative Initiative" style="border: 0;"/>
</a></h1>
   </div>
