...
path.mw.importer    = 'M:\Dropbox\web\sites\cbp-transcription-desk.local\w\maintenance\importDump.php'
...
path.image.export   = 'M:\Dropbox\web\sites\cbp-transcription-desk.local\zimages'
;path.image.export  = 'M:\Dropbox\web\sites\cbp-transcription-desk.local\scripts\tests\Files\output\images'
path.xml.export     = 'M:\Dropbox\web\sites\cbp-transcription-desk.local\scripts\tests\Files\output\text'
path.logs           = 'M:\Dropbox\web\sites\cbp-transcription-desk.local\scripts\tests\Files\logs'
path.archive        = 'M:\Dropbox\web\sites\cbp-transcription-desk.local\scripts\tests\Files\archive'
system.group        =
